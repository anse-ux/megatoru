...
exports.PROCESSABLE_HISTORY_TYPES = [
    ...
    WAProto_1.proto.Message.HistorySyncType.NON_BLOCKING_DATA,
    WAProto_1.proto.Message.HistorySyncType.INITIAL_STATUS_V3
]
...
exports.DEFAULT_CONNECTION_CONFIG = {
    ...
    logger: logger_1.default.child({ class: 'ryze' }),
    printQRInTerminal: false,
    emitOwnEvents: true,
    defaultQueryTimeoutMs: 8000,
    customUploadHosts: ["https://upload.whatsapp.com"],
